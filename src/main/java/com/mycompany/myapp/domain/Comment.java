...
public class Comment implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "user", "projectSupporteds", "cellTypes", "comments" }, allowSetters = true)
    ...
    public Comment timedate(ZonedDateTime timedate) {
    ...
    public Comment cellModel(CellModel cellModel) {
