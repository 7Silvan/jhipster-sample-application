...
public class CellModelCriteria implements Serializable, Criteria {
    ...
    private StringFilter limitationPercieved;
    ...
    public CellModelCriteria(CellModelCriteria other) {
        ...
        this.limitationPercieved = other.limitationPercieved == null ? null : other.limitationPercieved.copy();
    ...
    public BooleanFilter getMatrix() {
        return matrix;
    }

    public BooleanFilter matrix() {
        if (matrix == null) {
            matrix = new BooleanFilter();
        }
        return matrix;
    }

    public void setMatrix(BooleanFilter matrix) {
        this.matrix = matrix;
    }
    ...
    public StringFilter getLimitationPercieved() {
        return limitationPercieved;
    }

    public StringFilter limitationPercieved() {
        if (limitationPercieved == null) {
            limitationPercieved = new StringFilter();
        }
        return limitationPercieved;
    }

    public void setLimitationPercieved(StringFilter limitationPercieved) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(limitationPercieved, that.limitationPercieved) &&
    ...
    public String toString() {
        return "CellModelCriteria{" +
            ...
            (link != null ? "link=" + link + ", " : "") +
            (limitationPercieved != null ? "limitationPercieved=" + limitationPercieved + ", " : "") +
