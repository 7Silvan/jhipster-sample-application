...
public class CellModelResource {
    ...
    public CellModelResource(CellModelService cellModelService, CellModelRepository cellModelRepository) {
    ...
    public ResponseEntity<List<CellModelDTO>> getAllCellModels(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of CellModels");
        Page<CellModelDTO> page = cellModelService.findAll(pageable);
