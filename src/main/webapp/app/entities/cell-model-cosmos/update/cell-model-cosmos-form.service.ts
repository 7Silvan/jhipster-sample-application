...
type CellModelCosmosFormGroupContent = {
  ...
  characterizationData: FormControl<CellModelCosmosFormRawValue['characterizationData']>;
  ...
  isRegulatorySubmission: FormControl<CellModelCosmosFormRawValue['isRegulatorySubmission']>;
  publications: FormControl<CellModelCosmosFormRawValue['publications']>;
...
export class CellModelCosmosFormService {
  createCellModelCosmosFormGroup(cellModel: CellModelCosmosFormGroupInput = { id: null }): CellModelCosmosFormGroup {
    ...
    return new FormGroup<CellModelCosmosFormGroupContent>({
      ...
      characterizationData: new FormControl(cellModelRawValue.characterizationData),
      ...
      isRegulatorySubmission: new FormControl(cellModelRawValue.isRegulatorySubmission, {
        validators: [Validators.required],
      }),
      publications: new FormControl(cellModelRawValue.publications),
