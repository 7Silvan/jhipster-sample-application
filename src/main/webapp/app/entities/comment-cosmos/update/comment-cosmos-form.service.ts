 ...
 */
type FormValueOf<T extends ICommentCosmos | NewCommentCosmos> = Omit<T, 'timeCreated'> & {
...
type CommentCosmosFormDefaults = Pick<NewCommentCosmos, 'id' | 'timeCreated'>;
...
type CommentCosmosFormGroupContent = {
  ...
  timeCreated: FormControl<CommentCosmosFormRawValue['timeCreated']>;
...
export class CommentCosmosFormService {
  createCommentCosmosFormGroup(comment: CommentCosmosFormGroupInput = { id: null }): CommentCosmosFormGroup {
    ...
    return new FormGroup<CommentCosmosFormGroupContent>({
      ...
      timeCreated: new FormControl(commentRawValue.timeCreated, {
        validators: [Validators.required],
      }),
  ...
  private convertCommentCosmosRawValueToCommentCosmos(
    ...
    return {
      ...rawCommentCosmos,
      timeCreated: dayjs(rawCommentCosmos.timeCreated, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertCommentCosmosToCommentCosmosRawValue(
    ...
    return {
      ...comment,
      timeCreated: comment.timeCreated ? comment.timeCreated.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
