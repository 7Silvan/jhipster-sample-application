...
class CellModelResourceIT {
    ...
    private static final String DEFAULT_LIMITATION_PERCEIVED = "AAAAAAAAAA";
    private static final String UPDATED_LIMITATION_PERCEIVED = "BBBBBBBBBB";
    ...
    public static CellModel createEntity(EntityManager em) {
        CellModel cellModel = new CellModel()
            ...
            .link(DEFAULT_LINK)
            .limitationPerceived(DEFAULT_LIMITATION_PERCEIVED);
        return cellModel;
    }
    ...
    public static CellModel createUpdatedEntity(EntityManager em) {
        CellModel cellModel = new CellModel()
            ...
            .link(UPDATED_LINK)
            .limitationPerceived(UPDATED_LIMITATION_PERCEIVED);
        return cellModel;
    }
    ...
    void createCellModel() throws Exception {
        ...
        assertThat(testCellModel.getNote()).isEqualTo(DEFAULT_NOTE);
        assertThat(testCellModel.getExperts()).isEqualTo(DEFAULT_EXPERTS);
        assertThat(testCellModel.getLink()).isEqualTo(DEFAULT_LINK);
        assertThat(testCellModel.getLimitationPerceived()).isEqualTo(DEFAULT_LIMITATION_PERCEIVED);
    }
    ...
    void getAllCellModels() throws Exception {
        ...
        restCellModelMockMvc
            ...
            .andExpect(jsonPath("$.[*].limitationPerceived").value(hasItem(DEFAULT_LIMITATION_PERCEIVED)));
    }
    ...
    void getCellModel() throws Exception {
        ...
        restCellModelMockMvc
            ...
            .andExpect(jsonPath("$.limitationPerceived").value(DEFAULT_LIMITATION_PERCEIVED));
    }
    ...
    @Test
    @Transactional
    void getAllCellModelsByNoteIsEqualToSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where note equals to DEFAULT_NOTE
        defaultCellModelShouldBeFound("note.equals=" + DEFAULT_NOTE);

        // Get all the cellModelList where note equals to UPDATED_NOTE
        defaultCellModelShouldNotBeFound("note.equals=" + UPDATED_NOTE);
    }

    @Test
    @Transactional
    void getAllCellModelsByNoteIsInShouldWork() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where note in DEFAULT_NOTE or UPDATED_NOTE
        defaultCellModelShouldBeFound("note.in=" + DEFAULT_NOTE + "," + UPDATED_NOTE);

        // Get all the cellModelList where note equals to UPDATED_NOTE
        defaultCellModelShouldNotBeFound("note.in=" + UPDATED_NOTE);
    }

    @Test
    @Transactional
    void getAllCellModelsByNoteIsNullOrNotNull() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where note is not null
        defaultCellModelShouldBeFound("note.specified=true");

        // Get all the cellModelList where note is null
        defaultCellModelShouldNotBeFound("note.specified=false");
    }

    @Test
    @Transactional
    void getAllCellModelsByNoteContainsSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where note contains DEFAULT_NOTE
        defaultCellModelShouldBeFound("note.contains=" + DEFAULT_NOTE);

        // Get all the cellModelList where note contains UPDATED_NOTE
        defaultCellModelShouldNotBeFound("note.contains=" + UPDATED_NOTE);
    }

    @Test
    @Transactional
    void getAllCellModelsByNoteNotContainsSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where note does not contain DEFAULT_NOTE
        defaultCellModelShouldNotBeFound("note.doesNotContain=" + DEFAULT_NOTE);

        // Get all the cellModelList where note does not contain UPDATED_NOTE
        defaultCellModelShouldBeFound("note.doesNotContain=" + UPDATED_NOTE);
    }
    ...
    @Test
    @Transactional
    void getAllCellModelsByLimitationPerceivedIsEqualToSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where limitationPerceived equals to DEFAULT_LIMITATION_PERCEIVED
        defaultCellModelShouldBeFound("limitationPerceived.equals=" + DEFAULT_LIMITATION_PERCEIVED);

        // Get all the cellModelList where limitationPerceived equals to UPDATED_LIMITATION_PERCEIVED
        defaultCellModelShouldNotBeFound("limitationPerceived.equals=" + UPDATED_LIMITATION_PERCEIVED);
    }

    @Test
    @Transactional
    void getAllCellModelsByLimitationPerceivedIsInShouldWork() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where limitationPerceived in DEFAULT_LIMITATION_PERCEIVED or UPDATED_LIMITATION_PERCEIVED
        defaultCellModelShouldBeFound("limitationPerceived.in=" + DEFAULT_LIMITATION_PERCEIVED + "," + UPDATED_LIMITATION_PERCEIVED);

        // Get all the cellModelList where limitationPerceived equals to UPDATED_LIMITATION_PERCEIVED
        defaultCellModelShouldNotBeFound("limitationPerceived.in=" + UPDATED_LIMITATION_PERCEIVED);
    }

    @Test
    @Transactional
    void getAllCellModelsByLimitationPerceivedIsNullOrNotNull() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where limitationPerceived is not null
        defaultCellModelShouldBeFound("limitationPerceived.specified=true");

        // Get all the cellModelList where limitationPerceived is null
        defaultCellModelShouldNotBeFound("limitationPerceived.specified=false");
    }

    @Test
    @Transactional
    void getAllCellModelsByLimitationPerceivedContainsSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where limitationPerceived contains DEFAULT_LIMITATION_PERCEIVED
        defaultCellModelShouldBeFound("limitationPerceived.contains=" + DEFAULT_LIMITATION_PERCEIVED);

        // Get all the cellModelList where limitationPerceived contains UPDATED_LIMITATION_PERCEIVED
        defaultCellModelShouldNotBeFound("limitationPerceived.contains=" + UPDATED_LIMITATION_PERCEIVED);
    }

    @Test
    @Transactional
    void getAllCellModelsByLimitationPerceivedNotContainsSomething() throws Exception {
        // Initialize the database
        cellModelRepository.saveAndFlush(cellModel);

        // Get all the cellModelList where limitationPerceived does not contain DEFAULT_LIMITATION_PERCEIVED
        defaultCellModelShouldNotBeFound("limitationPerceived.doesNotContain=" + DEFAULT_LIMITATION_PERCEIVED);

        // Get all the cellModelList where limitationPerceived does not contain UPDATED_LIMITATION_PERCEIVED
        defaultCellModelShouldBeFound("limitationPerceived.doesNotContain=" + UPDATED_LIMITATION_PERCEIVED);
    }
    ...
    void putExistingCellModel() throws Exception {
        ...
        assertThat(testCellModel.getNote()).isEqualTo(UPDATED_NOTE);
        assertThat(testCellModel.getExperts()).isEqualTo(UPDATED_EXPERTS);
        assertThat(testCellModel.getLink()).isEqualTo(UPDATED_LINK);
        assertThat(testCellModel.getLimitationPerceived()).isEqualTo(UPDATED_LIMITATION_PERCEIVED);
    }
