...
class CommentResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_TIMEDATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_TIMEDATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().text(DEFAULT_TEXT).timedate(DEFAULT_TIMEDATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().text(UPDATED_TEXT).timedate(UPDATED_TIMEDATE);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getTimedate()).isEqualTo(DEFAULT_TIMEDATE);
    }
    ...
    @Test
    @Transactional
    void checkTimedateIsRequired() throws Exception {
        int databaseSizeBeforeTest = commentRepository.findAll().size();
        // set the field null
        comment.setTimedate(null);
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].timedate").value(hasItem(sameInstant(DEFAULT_TIMEDATE))));
    }
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.timedate").value(sameInstant(DEFAULT_TIMEDATE)));
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).timedate(UPDATED_TIMEDATE);
        ...
        assertThat(testComment.getTimedate()).isEqualTo(UPDATED_TIMEDATE);
    }
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).timedate(UPDATED_TIMEDATE);
