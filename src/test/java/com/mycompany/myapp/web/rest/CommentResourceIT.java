...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().text(DEFAULT_TEXT).timeCreated(DEFAULT_TIME_CREATED);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().text(UPDATED_TEXT).timeCreated(UPDATED_TIME_CREATED);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getTimeCreated()).isEqualTo(DEFAULT_TIME_CREATED);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.text(UPDATED_TEXT).timeCreated(UPDATED_TIME_CREATED);
        ...
        assertThat(testComment.getTimeCreated()).isEqualTo(UPDATED_TIME_CREATED);
    }
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).timeCreated(UPDATED_TIME_CREATED);
